    ...
    def copyRandomList(self, head: 'Optional[Node]') -> 'Optional[Node]':
        ...
        while current != None:
            ...
            if current.next != None:
                newNext = refs.setdefault(current.next, Node(current.next.val))

            newRand = None
            if current.random != None:
                newRand = refs.setdefault(current.random, Node(current.random.val))

            newCurrent = refs.setdefault(current, Node(current.val))
